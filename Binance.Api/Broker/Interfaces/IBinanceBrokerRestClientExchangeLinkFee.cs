...
/// </summary>
public interface IBinanceBrokerRestClientExchangeLinkFee
{
    /// <summary>
    ...
    Task<RestCallResult<BinanceBrokerSubAccountCommission>> SetCommissionAsync(string subAccountId, decimal makerCommission, decimal takerCommission, decimal? marginMakerCommission = null, decimal? marginTakerCommission = null, int? receiveWindow = null, CancellationToken ct = default);
    ...
    Task<RestCallResult<BinanceBrokerSubAccountFuturesCommission>> SetFuturesCommissionAdjustmentAsync(string subAccountId, string symbol, int makerAdjustment, int takerAdjustment, int? receiveWindow = null, CancellationToken ct = default);
    ...
    Task<RestCallResult<List<BinanceBrokerSubAccountFuturesCommission>>> GetFuturesCommissionAdjustmentAsync(string subAccountId, string? symbol = null, int? receiveWindow = null, CancellationToken ct = default);
    ...
    Task<RestCallResult<BinanceBrokerSubAccountCoinFuturesCommission>> SetCoinFuturesCommissionAdjustmentAsync(string subAccountId, string pair, int makerAdjustment, int takerAdjustment, int? receiveWindow = null, CancellationToken ct = default);
    ...
    Task<RestCallResult<List<BinanceBrokerSubAccountFuturesCommission>>> GetCoinFuturesCommissionAdjustmentAsync(string subAccountId, string? pair = null, int? receiveWindow = null, CancellationToken ct = default);
    ...
    Task<RestCallResult<List<BinanceBrokerRebate>>> GetBrokerCommissionRebatesAsync(string subAccountId, DateTime? startDate = null, DateTime? endDate = null, int? page = null, int? size = null, int? receiveWindow = null, CancellationToken ct = default);
    ...
    Task<RestCallResult<List<BinanceBrokerFuturesRebate>>> GetBrokerFuturesCommissionRebatesAsync(BinanceFuturesType futuresType, DateTime startDate, DateTime endDate, int? page = null, int? size = null, int? receiveWindow = null, CancellationToken ct = default);
}