...
internal partial class BinanceBrokerRestClientExchangeLink(BinanceBrokerRestClient parent) : IBinanceBrokerRestClientExchangeLink
{
    // Api
    ...
    {
        var url = BinanceAddress.Default.BrokerExchangeLinkRestApiAddress.AppendPath(api);
