...
/// </summary>
public record BinanceFuturesStreamCoinKlineData : BinanceSocketEvent, IBinanceStreamKlineData
{
    /// <summary>
    ...
    /// </summary>
    [JsonProperty("k")]
    [JsonConverter(typeof(BinanceInterfaceConverter<BinanceFuturesStreamCoinKline>))]
