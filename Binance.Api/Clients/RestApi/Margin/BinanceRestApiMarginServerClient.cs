...
public class BinanceRestApiMarginServerClient
{
    ...
    public async Task<RestCallResult<BinanceExchangeInfo>> GetExchangeInfoAsync(AccountType[] permissions, CancellationToken ct = default)
    {
        ...
        MarginClient.ExchangeInfo = exchangeInfoResult.Data;
        MarginClient.LastExchangeInfoUpdate = DateTime.UtcNow;
        MarginClient.Log.Write(LogLevel.Information, "Trade rules updated");
        return exchangeInfoResult;
    }
