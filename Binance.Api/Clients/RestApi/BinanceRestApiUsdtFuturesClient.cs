...
public class BinanceRestApiUsdtFuturesClient : RestApiClient
{
    ...
    public async Task<RestCallResult<IEnumerable<BinanceFuturesUsdtTrade>>> GetUserTradesAsync(string symbol, DateTime? startTime = null, DateTime? endTime = null, int? limit = null, long? fromId = null, long? receiveWindow = null, CancellationToken ct = default)
    {
        ...
        return await SendRequestInternal<IEnumerable<BinanceFuturesUsdtTrade>>(GetUrl(myFuturesTradesEndpoint, fapi, v1), HttpMethod.Get, ct, true, queryParameters: parameters, requestWeight: 5).ConfigureAwait(false);
    }
    #endregion
