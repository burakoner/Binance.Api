...
public interface IBinanceMarginRestClientTransfer
{
    ...
    Task<RestCallResult<BinanceRowsResult<BinanceMarginTransferHistory>>> GetMarginTransfersAsync(BinanceMarginTransferDirection direction, int? page = null, DateTime? startTime = null, DateTime? endTime = null, int? limit = null, string? isolatedSymbol = null, int? receiveWindow = null, CancellationToken ct = default);
