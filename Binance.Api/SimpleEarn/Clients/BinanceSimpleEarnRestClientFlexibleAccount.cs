...
internal partial class BinanceSimpleEarnRestClientFlexible
{
    ...
    public Task<RestCallResult<BinanceRowsResult<BinanceSimpleEarnFlexibleProduct>>> GetProductsAsync(string? asset = null, int? page = null, int? pageSize = null, int? receiveWindow = null, CancellationToken ct = default)
    {
        var parameters = new ParameterCollection();
        ...
        return RequestAsync<BinanceRowsResult<BinanceSimpleEarnFlexibleProduct>>(GetUrl(sapi, v1, "simple-earn/flexible/list"), HttpMethod.Get, ct, true, queryParameters: parameters, requestWeight: 150);
    }

    public Task<RestCallResult<BinanceRowsResult<BinanceSimpleEarnFlexiblePosition>>> GetPositionsAsync(string? asset = null, string? productId = null, int? page = null, int? pageSize = null, int? receiveWindow = null, CancellationToken ct = default)
    {
        var parameters = new ParameterCollection();
        parameters.AddOptional("asset", asset);
        ...
        return RequestAsync<BinanceRowsResult<BinanceSimpleEarnFlexiblePosition>>(GetUrl(sapi, v1, "simple-earn/flexible/position"), HttpMethod.Get, ct, true, queryParameters: parameters, requestWeight: 150);
    }
