...
internal partial class BinanceSimpleEarnRestClientLocked(BinanceSimpleEarnRestClient parent) : IBinanceSimpleEarnRestClientLocked
{
    // Api
    ...
    {
        var url = BinanceAddress.Default.SimpleEarnRestApiAddress;
