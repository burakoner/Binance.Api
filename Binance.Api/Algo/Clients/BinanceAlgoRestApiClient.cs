...
internal class BinanceAlgoRestApiClient: IBinanceAlgoRestApiClient
{
    // Api
    ...
    public IBinanceAlgoRestApiClientSpot Spot { get; }
    public IBinanceAlgoRestApiClientFutures Futures { get; }

    // Constructor
    internal BinanceAlgoRestApiClient(BinanceRestApiClient root)
    {
        _ = root;
        Spot = new BinanceAlgoRestApiClientSpot(this);
        Futures = new BinanceAlgoRestApiClientFutures(this);
    }
