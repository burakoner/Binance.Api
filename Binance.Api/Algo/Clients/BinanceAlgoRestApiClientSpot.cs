...
internal class BinanceAlgoRestApiClientSpot(BinanceAlgoRestApiClient parent) : IBinanceAlgoRestApiClientSpot
{
    // Api
    ...
    // Parent
    internal BinanceAlgoRestApiClient _ { get; } = parent;
    ...
    {
        clientOrderId = BinanceHelpers.ApplyBrokerId(clientOrderId, BinanceConstants.ClientOrderIdSpot, 36, _.RestApiOptions.AllowAppendingClientOrderId);
