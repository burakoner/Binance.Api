...
internal partial class BinanceLinkRestClientExchangeLink(BinanceLinkRestClient parent) : IBinanceLinkRestClientExchangeLink
{
    // Api
    ...
    private BinanceLinkRestClient _ { get; } = parent;
    ...
    {
        var url = BinanceAddress.Default.ExchangeLinkRestApiAddress;
