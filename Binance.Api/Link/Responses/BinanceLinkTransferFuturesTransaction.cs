...
/// </summary>
public record BinanceLinkTransferFuturesTransactions
{
    /// <summary>
    /// Success
    /// </summary>
    ...
    public List<BinanceLinkTransferFuturesTransaction> Transactions { get; set; } = [];
}

/// <summary>
/// Transfer Futures Transaction
/// </summary>
public record BinanceLinkTransferFuturesTransaction
{
    /// <summary>
    /// From Id
    /// </summary>
