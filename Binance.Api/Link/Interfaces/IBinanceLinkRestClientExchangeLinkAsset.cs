...
/// </summary>
public interface IBinanceLinkRestClientExchangeLinkAsset
{
    /// <summary>
    ...
    Task<RestCallResult<BinanceLinkTransferResult>> TransferAsync(string asset, decimal quantity, string? fromId, string? toId, string? clientTransferId = null, int? receiveWindow = null, CancellationToken ct = default);
    ...
    Task<RestCallResult<List<BinanceLinkTransferTransaction>>> GetTransfersAsync(string? fromId = null, string? toId = null, string? clientTransferId = null, DateTime? startDate = null, DateTime? endDate = null, int? page = null, int? limit = null, bool showAllStatus = false, int? receiveWindow = null, CancellationToken ct = default);
    ...
    /// <param name="ct">Cancellation token</param>
    /// <returns>Transfer result</returns>
    Task<RestCallResult<BinanceLinkTransferFuturesResult>> FuturesTransferAsync(string asset, decimal quantity, BinanceFuturesType futuresType, string? fromId, string? toId, string? clientTransferId = null, int? receiveWindow = null, CancellationToken ct = default);
    ...
    /// <param name="ct">Cancellation token</param>
    /// <returns>Transfer history</returns>
    Task<RestCallResult<BinanceLinkTransferFuturesTransactions>> GetFuturesTransfersAsync(string subAccountId, BinanceFuturesType futuresType, DateTime? startDate = null, DateTime? endDate = null, int? page = null, int? limit = null, string? clientTransferId = null, int? receiveWindow = null, CancellationToken ct = default);
    ...
    /// <param name="ct">Cancellation token</param>
    /// <returns></returns>
    Task<RestCallResult<List<BinanceLinkSubAccountDepositTransaction>>> GetDepositsAsync(string? subAccountId = null, string? asset = null, BinanceDepositStatus? status = null, DateTime? startDate = null, DateTime? endDate = null, int? limit = null, int? offset = null, int? receiveWindow = null, CancellationToken ct = default);
    ...
    Task<RestCallResult<BinanceLinkSpotAssetInfo>> GetSpotAssetInfoAsync(string? subAccountId = null, int? page = null, int? size = null, int? receiveWindow = null, CancellationToken ct = default);
    ...
    /// <param name="ct">Cancellation token</param>
    /// <returns>Asset info</returns>
    Task<RestCallResult<BinanceLinkMarginAssetInfo>> GetMarginAssetInfoAsync(string? subAccountId = null, int? page = null, int? size = null, int? receiveWindow = null, CancellationToken ct = default);
    ...
    /// <param name="ct">Cancellation token</param>
    /// <returns>Asset info</returns>
    Task<RestCallResult<BinanceLinkFuturesAssetInfo>> GetFuturesAssetInfoAsync(BinanceFuturesType futuresType, string? subAccountId = null, int? page = null, int? size = null, int? receiveWindow = null, CancellationToken ct = default);
    ...
    /// <param name="ct">Cancellation token</param>
    /// <returns>Transfer result</returns>
    Task<RestCallResult<BinanceLinkTransferResult>> UniversalTransferAsync(string asset, decimal quantity, string? fromId, BinanceLinkAccountType fromAccountType, string? toId, BinanceLinkAccountType toAccountType, string? clientTransferId = null, int? receiveWindow = null, CancellationToken ct = default);
    ...
    /// <param name="ct">Cancellation token</param>
    /// <returns>Transfer history</returns>
    Task<RestCallResult<List<BinanceLinkTransferTransactionUniversal>>> GetUniversalTransfersAsync(string? fromId = null, string? toId = null, string? clientTransferId = null, DateTime? startDate = null, DateTime? endDate = null, int? page = null, int? limit = null, bool showAllStatus = false, int? receiveWindow = null, CancellationToken ct = default);
}