...
/// </summary>
public interface IBinanceLinkRestClientLinkAndTradeFastApi
{
    ...
    /// <returns></returns>
    Task<RestCallResult<BinanceLinkFastUserStatus>> GetUserStatusAsync(string accessToken, CancellationToken ct = default);
    ...
    /// <param name="ct">Cancellation token</param>
    /// <returns></returns>
    Task<RestCallResult<BinanceLinkFastApiKey>> CreateApiKeyForUserAsync(
        string accessToken,
        string apiName,
        bool enableTrade,
