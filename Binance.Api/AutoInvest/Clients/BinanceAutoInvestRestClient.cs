...
internal partial class BinanceAutoInvestRestClient(BinanceRestApiClient root) : IBinanceAutoInvestRestClient
{
    // Api
    ...
    {
        var url = BinanceAddress.Default.AutoInvestRestApiAddress.AppendPath(api);
