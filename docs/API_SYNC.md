...
1. Audit the 10 remaining Spot trading REST routes and their WebSocket API counterparts against their canonical pages, gathering verified rate-limit dimensions with each endpoint.
