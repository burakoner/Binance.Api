...
1. Audit the remaining Spot trading/account REST and WebSocket API routes against their canonical pages, gathering verified rate-limit dimensions with each endpoint.
